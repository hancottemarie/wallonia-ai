...
42. TODO : rajout d'info's dans le pdf qui sont pas sur l'interface et faire un vrai itineraire en ce basant sur les descriptions longues du destinations.json donc encore interventon de l'IA. Voir meme une fenetre qui s'ouvre en peu sur le cote une sorte de rectangle ou on peut faire un drag & drop pour creer notre itene
