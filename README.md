...
34. Ajout d'images supplementaires(images specifiques pour chaque destinations dans destinations.json) et icone sur la carte(a ammeliorer) plus random dans le main.py pour des % differents
