...
14. modif de main.py pour appeler la bibliotheque ctypes pour appeler la fonction c :  Chargement de la librairie C
# Adapte l'extension .so ou .dll selon ton OS
