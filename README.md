...
23. JSX: jsvascript xml : extension de syntaxe pour javascript melange de java +html. POURQUOI? : ecrit la structure de mon interface (html). en gros on passe de React.createElement('h1', {className: 'title'}, 'Hello') ------a------
24. ❓ C'est quoi Axios ?
